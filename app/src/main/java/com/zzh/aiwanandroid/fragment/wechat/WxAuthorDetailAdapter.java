...
public class WxAuthorDetailAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public WxAuthorDetailAdapter(List<Article> articles) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof ContentViewHolder) {
            WxAuthorDetailAdapter.ContentViewHolder contentViewHolder = (WxAuthorDetailAdapter.ContentViewHolder) holder;
            Article article = mArticles.get(position);
            if (article.isFresh()) {
                // 判断是否是新上线的
        ...
        if (holder instanceof FootViewHolder) {
            ...
            if (WxAuthorDetailFragment.getLoadIsOver()) {
